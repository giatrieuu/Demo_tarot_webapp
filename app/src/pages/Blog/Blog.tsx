    ...
    getPagedPost({ searchTerm: "" }, 1, 10)
      .then((data) => {
        if (data && Array.isArray(data.posts)) {
          const sortedBlogs = data.posts.sort(
            (a: Blog, b: Blog) =>
              new Date(b.post.createAt).getTime() -
              new Date(a.post.createAt).getTime()
          );
      ...
      >
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center">
          ...
          <p className="text-white text-center max-w-2xl mt-4 text-xl mb-8">
            Dive into a world of insights and inspiration. Discover our latest
            articles, stay updated on trends, and uncover valuable knowledge
            that fuels your creativity.
          </p>
          <Search
